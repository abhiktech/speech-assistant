...
IFontDisp = Font
__all__ = [ 'IFontDisp', 'FONTBOLD', 'OLE_YPOS_PIXELS',
           'OLE_XPOS_HIMETRIC', 'FONTITALIC', 'StdPicture',
           'FONTSTRIKETHROUGH', 'StdFont', 'OLE_XPOS_CONTAINER',
           'Font', 'OLE_CANCELBOOL', 'OLE_YSIZE_CONTAINER',
           'OLE_XSIZE_HIMETRIC', 'OLE_XSIZE_PIXELS', 'OLE_COLOR',
           'IPictureDisp', 'Unchecked', 'Checked',
           'OLE_ENABLEDEFAULTBOOL', 'OLE_OPTEXCLUSIVE', 'Color',
           'FONTNAME', 'FontEvents', 'VgaColor', 'OLE_YPOS_CONTAINER',
           'Gray', 'IPicture', 'Picture', 'Monochrome',
           'OLE_TRISTATE', 'OLE_HANDLE', 'OLE_YPOS_HIMETRIC',
           'FONTUNDERSCORE', 'LoadPictureConstants', 'Default',
           'OLE_YSIZE_PIXELS', 'IFontEventsDisp',
           'OLE_XSIZE_CONTAINER', 'IFont', 'FONTSIZE',
           'OLE_XPOS_PIXELS', 'OLE_YSIZE_HIMETRIC']
